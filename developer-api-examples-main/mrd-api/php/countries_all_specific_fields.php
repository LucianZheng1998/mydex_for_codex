...
// This script queries the Countries MRD endpoint, for all countries,
// and specifically just their name, cca2 and flag fields.
...
define("OAUTH_MRD_SCOPES", "countries");
define("OAUTH_MRD_GRANT_TYPE", "client_credentials");
define("MRD_API_ENDPOINT", "https://api-mrd.mydex.org/countries");
...
function request_countries($token) {
    $params = array(
        'filters' => array(
            'name',
	    'cca2',
