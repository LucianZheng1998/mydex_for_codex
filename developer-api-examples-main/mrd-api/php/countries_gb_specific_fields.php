...
// This script queries the Countries MRD endpoint, specifically the UK,
// and specifically just its name, idd and maps fields.
...
define("MRD_API_ENDPOINT", "https://api-mrd.mydex.org/countries/GB");
...
function request_country($token) {
    $params = array(
        'filters' => array(
            'name',
	    'idd',
